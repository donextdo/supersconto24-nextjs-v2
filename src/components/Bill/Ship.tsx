...
{/* {companyNameError && <div className='text-red-500'>{companyNameError}</div>} */}
            ...
            <input type="text" className="w-full h-10 bg-gray-100 rounded-md mt-2 mb-2 px-4" placeholder="House number and street name" value={streetAddress} onChange={handleStreetAddressChange} required/>
            ...
            <input type="text" className="w-full h-10 bg-gray-100 rounded-md mt-2 mb-4 px-4" value={townCity} onChange={handleTownCityChange} required/>
            {townCityError && <div className='text-red-500'>{townCityError}</div>}

            <label className="text-sm">State *</label>
            <input type="text" className="w-full h-10 bg-gray-100 rounded-md mt-2 mb-4 px-4" value={state} onChange={handleStateChange} required/>
            {stateError && <div className='text-red-500'>{stateError}</div>}

            <label className="text-sm">Zip Code *</label>
            <input type="text" className="w-full h-10 bg-gray-100 rounded-md mt-2 mb-4 px-4" value={zipCode} onChange={handleZipCodeChange} required/>
            {zipCodeError && <div className='text-red-500'>{zipCodeError}</div>}

            <label className="text-sm">Phone *</label>
            <input type="text" className="w-full h-10 bg-gray-100 rounded-md mt-2 mb-4 px-4" value={phone} onChange={handlePhoneChange} required/>
