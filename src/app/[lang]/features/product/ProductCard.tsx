...
export const ProductCard: FC<Props> = ({product}) => {
    ...
    const [ratio, targetRate, localeRate] = useCurrency("EUR", searchParams.get("currency") ?? "EUR")
    ...
    console.log(product.unit_price * ratio, {ratio, targetRate, localeRate})
    return (
        <>
            <div
            ...
            <span className="text-gray-400 text-sm line-through mr-2 my-1 font-[1.125rem]">
              ${(product.unit_price * ratio).toFixed(2) as unknown as ReactElement}
            </span>
                        {product.discount && (
